...
export const FORM_SCHEMAS: Record<string, FieldSchema[]> = {
  [TABLES.DATA]: [
    ...
    { name: "สินค้า", type: "Enum", values: ["1 เหล็กเส้น", "2 เหล็กรูปพรรณ", "3 คอนกรีต", "4 ไม้แบบ", "5 วัสดุมุง", "6 ฝ้าผนัง", "7 ปูพื้น", "8 กระจก", "9 ไฟฟ้า", "10 ประปา", "11 อื่นๆ(วัสดุ)", "12 สีเคมี", "13 สุขภัณฑ์", "14 บิวอิน", "15 แอร์", "16 ดิน", "17 หินทราย", "18 เตรียมงาน", "101 น้ำมัน", "102 ค่าขนส่ง", "103 เครื่องจักร", "200 ดำเนินการ(อื่นๆ)", "non"], description: "อื่นๆคือสินค้าทั่วไป | non : 7.เครื่องมือ 8.อื่นๆ ที่พัก", showIf: { column: "ร้านค้า/ผู้รับเหมา", equals: "ร้านค้า" } },
    ...
    { name: "เครดิต", type: "Enum", values: ["30", "45", "60", "ระบุเอง"], inputMode: "buttons", showIf: { column: "vat", notBlank: true } },
  ...
  [TABLES.PROJECT]: [
    ...
    { name: "งบไม่เกินเหล็กเส้น", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินรูปพรรณ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินคอนกรีต", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินไม้แบบ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินวัสดุมุง", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินฝ้าผนัง", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินปูพื้น", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินกระจก", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินไฟฟ้า", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินประปา", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินอื่นๆ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน1", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินสีเคมี", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินสุขภัณฑ์", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินบิวอิน", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินแอร์", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินดิน", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินหินทราย", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินเตรียมงาน", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายประเภทงาน2", "คุมงบรายสินค้า (18 หมวด)", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินค่าของ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายเงิน", "คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)", "คุมงบรายสินค้า (18 หมวด)"] } },
    { name: "งบไม่เกินค่าแรง", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["รวมจ่ายเงิน", "คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)", "คุมงบรายสินค้า (18 หมวด)"] } },
    { name: "งบไม่เกินพนักงาน", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินน้ำมัน", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินซ่อมรถ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินเครื่องจักร", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)"] } },
    { name: "งบไม่เกินเครื่องมือ", type: "Number", showIf: { column: "คุมงบประเภทงาน", in: ["คุมงบ 8 หมวดหลัก", "กำหนดเอง (Custom Matrix)"] } }
  ],
  [TABLES.BANK]: [
  ...
  [TABLES.PRODUCT]: [
    { name: "id_product", type: "Text", key: true, initialValue: "nextProductId", required: true },
    { name: "รหัสสินค้า", type: "Text", required: true },
    { name: "ชื่อประเภทสินค้า", type: "Text", required: true },
    { name: "หมายเหตุ", type: "Text" }
  ]
};
