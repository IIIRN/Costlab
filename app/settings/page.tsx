    ...
    <div className="p-3 sm:p-5 max-w-5xl mx-auto space-y-3.5 font-sans text-xs text-slate-800">
      ...
      <div className="flex items-center justify-between pt-1">
        <button
          ...
          className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium rounded border border-slate-300 transition flex items-center gap-1.5 cursor-pointer text-xs"
        >
          <Copy size={13} />
